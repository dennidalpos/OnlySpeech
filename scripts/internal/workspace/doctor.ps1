...
function Get-MicrophoneRepairCommand {
  ...
  return "powershell -ExecutionPolicy Bypass -File .\\scripts\\internal\\runtime\\repair-microphones.ps1"
}
...
$launcherPath = Join-Path $repoRoot "scripts\public\start.ps1"
if (Test-Path $launcherPath) {
$relativeLauncher = "scripts\public\start.ps1"
...
if ($env:OS -eq "Windows_NT" -or [System.Environment]::OSVersion.Platform -eq "Win32NT") {
  ...
  $runtimeDoctorPath = Join-Path $repoRoot "scripts\internal\runtime\workstation-runtime-doctor.ps1"
